...
The function `strsplit()` allows you to break a string into smaller parts, based on a specifc criteria.  In the example below we break our sample names where there is a space.
...
In cases like our example above, where we know every entry will be split into a consitent number of parts, it's often easier to transform this output into a matrix or data.frame where each row represents an entry.
