...
- `brewer.pal` function creates a vector of the specified length comprising colours from the named pallette
...
plot(data[,1], pch=16, col=mycols)
text(c(117,62,99,121,30), data[c(117,62,99,121,30),1], labels=c(117,62,99,121,30))
```
...
- Can be used to draw a *line of best fit*
